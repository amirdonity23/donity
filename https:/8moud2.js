(function(){
    function installSeal() {
        ...
        box.style.setProperty("--seal-flower-url", "url('https://up6.cc/2026/06/178082306606071.png')");
        box.innerHTML = `<div class="seal-flower-wrap"><span class="seal-flower-wreath"></span><div class="seal-circle"><span class="seal-rim"></span><span class="seal-rim-2"></span><span class="ring-outer"></span><span class="ring-inner"></span><span class="ring-core"></span><img src="https://up6.cc/2026/06/178082263500171.png" alt=""></div></div><div class="seal-text">مرحبا بكم في شاتكم </div><div class="seal-line"></div><div class="seal-sub">كونوا لطفاء فالعالم سيء بما يكفي</div><div style="margin-top:12px;direction:ltr;font-size:12px;color:#c47c7b;font-weight:500"><span style="display:inline-block;margin-left:8px;">Designed by <strong style="color:#e8917a">donity</strong></span><span style="display:inline-block;margin-right:8px;">|</span><span style="display:inline-block;">شـــــات  : <strong style="color:#e8917a">غمـــــــوض الجوال </strong></span></div>`;
