...
$(`<div class='management-team' id='managementTeam' style='display:none'>
  <center>
    ...
    <div class='team-members'>
      <div class='member'>
        <img src='https://178111494294661.jpg'>
        <b>ادارة الموقع</b>
        <span>فٍطٍيٍمٍ</span>
      </div>
      <div class='member'>
        <img src='https:/2026/0.jpg'>
        <b>صاحبة الموقع</b>
        <span>𝚏5𝚖</span>
      </div>
      <div class='member'>
        <img src='https:/2026/06/1781'>
        <b>المشرف العام</b>
        <span> ---</span>
      </div>
    </div>
    <hr>
    <div class='team-contact'>تصميم :آٍمٍيٍرٍ ډٍۅٍنٍيٍتٍيٍ </div>
    <div class='team-contact'>جميع الحقوق : شات غٍمٍۅٍضٍ</div>
  </center>
  ...
  <div class="slider-header">
    <div width="95%" style="background-color: #F5E6D3; color: #000000; border-radius: 8px 8px 20px 20px; border-bottom: 2px solid #ABABAB; border-top: 2px solid #ABABAB; padding: 0px !important; background-repeat: no-repeat; background-size: cover; background-position: center;">
      <font style="background-color: #D4C4A8; border-radius: 12px; font-family: 'Almarai', 'jazeera', FontAwesome; padding: 2px 15px; margin: 3px 10px; display: inline-block; font-size: 13px; font-weight: 400;">
        مرحبـــاً بكم في شات  غمـــوض للجوال</font>
    </div>
  </div>
  ...
  <center>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; margin: 15px 0;">
      <div style="text-align: center;">
        <img src="https://up6.cc/2026/06/178111494294661.jpg" style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #b93068; box-shadow: 0 0 8px rgba(185,48,104,0.5);">
        ...
        <br><span style="color: #BF1D6E; font-family: 'El Messiri', 'jazeera', sans-serif; font-size: 13px;">طـــرب</span>
      </div>
      <div style="text-align: center;">
        <img src="https://up6.cc/2026/06/178111524947621.jpg" style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #b93068; box-shadow: 0 0 8px rgba(185,48,104,0.5);">
        ...
        <br><span style="color: #BF1D6E; font-family: 'El Messiri', 'jazeera', sans-serif; font-size: 13px;">مهــــا</span>
      </div>
      <div style="text-align: center;">
        <img src="https://up6.cc/2026/06/178111505605451.jpg" style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #b93068; box-shadow: 0 0 8px rgba(185,48,104,0.5);">
        ...
        <br><span style="color: #BF1D6E; font-family: 'El Messiri', 'jazeera', sans-serif; font-size: 13px;">عمـــوشه</span>
      </div>
    </div>
    <hr style="border-color: #b93068; margin: 10px 0;">
    <div style="color: #555; font-family: 'El Messiri', 'jazeera', sans-serif; font-size: 13px; margin-top: 10px; text-align: center;">تصميم : امير دونيتي </div>
    <div style="color: #555; font-family: 'El Messiri', 'jazeera', sans-serif; font-size: 13px; margin-top: 5px; text-align: center;">جميع الحقوق : شات غمــوض للجوال </div>
  </center>
